...
def pixel_tilemap_47(project_root: str, asset_name: str, tileset_path: str, tile_size: int = 32, content_path: str = "/Game/UIM/Tiles") -> dict[str, Any]:
    ...
    def run(root: Path) -> dict[str, Any]:
        ...
        return _ok(root, _manifest_result(manifest), ui_state={"asset_name": asset_name, "pixel_kind": "tilemap", "stage": "tilemap", "action": "idle", "direction": "south", "sheet_mode": "direct", "last_tool": "pixel_tilemap_47", "last_message": "Tilemap manifest generated by MCP."}, next_stage="tilemap")
...
def pixel_tilemap_dual_grid(project_root: str, asset_name: str, tileset_path: str, tile_size: int = 32, content_path: str = "/Game/UIM/Tiles") -> dict[str, Any]:
    ...
    def run(root: Path) -> dict[str, Any]:
        ...
        return _ok(root, _manifest_result(manifest), ui_state={"asset_name": asset_name, "pixel_kind": "tilemap", "stage": "tilemap", "action": "idle", "direction": "south", "sheet_mode": "direct", "last_tool": "pixel_tilemap_dual_grid", "last_message": "Dual-grid tilemap manifest generated by MCP."}, next_stage="tilemap")
